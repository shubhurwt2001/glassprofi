...
<head>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{asset('backendassets/plugins/summernote/summernote-bs4.min.css')}}">
  <!--SimpleMDE -->
  <link rel="stylesheet" href="{{asset('backendassets/newplugins/simplemde/dist/simplemde.min.css')}}">
  ...
  <link rel="stylesheet" href="{{asset('backendassets/plugins/datatables-buttons/css/buttons.bootstrap4.min.css')}}">
